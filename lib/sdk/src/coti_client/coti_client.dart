...
import 'package:aptosdart/sdk/src/coti_account/coti_account.dart';
...
class CoTiClient extends BaseWalletClient with AptosSDKMixin {
  ...
  Future<CoTiAccount> _computeEthereumAccount(AccountArg arg) async {
    CoTiAccount suiAccount;
    if (arg.mnemonics != null) {
      suiAccount = CoTiAccount(mnemonics: arg.mnemonics!);
    } else {
      suiAccount = CoTiAccount.fromPrivateKey(arg.privateKeyHex!);
    }
    return suiAccount;
  }
